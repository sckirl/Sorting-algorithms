...
class Algorithm(object):
    ...
    def A_star(self):
        try:
            ...
            if len(self.open_list) > 0 and self.Astar_run:
                ...
                # generate children
                for new_position in [(0, -20), (0, 20), (-20, 0), (20, 0), (-20, -20), (-20, 20), (20, -20),
                                     (20, 20)]:  # make square-shaped new positions
                    new_child = (
                    self.current_node.position[0] + new_position[0], self.current_node.position[1] + new_position[1])
    ...
    def draw(self):
        ...
        for nodes in range(1, len(self.path)):
            try:
                pygame.draw.rect(win, [242, 145, 61],
                                 (self.path[nodes].position[0], self.path[nodes].position[1], 20, 20))
            except:
                pass
